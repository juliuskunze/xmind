...
public class StatusHandlerMessages extends NLS {
    ...
    public static String RuntimeErrorDialog_HideDetailsButton_text;
    public static String RuntimeErrorDialog_IgnoreButton_text;
    public static String RuntimeErrorDialog_ReportButton_text;
    public static String RuntimeErrorDialog_ShowDetailsButton_text;
