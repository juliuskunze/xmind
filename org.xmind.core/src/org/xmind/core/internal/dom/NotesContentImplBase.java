...
public abstract class NotesContentImplBase implements INotesContent {

    private Element implementation;

    private WorkbookImpl ownedWorkbook;

    public NotesContentImplBase(Element implementation,
    ...
    public boolean equals(Object obj) {
        if (obj == this)
            return true;
        if (obj == null || !(obj instanceof NotesContentImplBase))
            return false;
        NotesContentImplBase that = (NotesContentImplBase) obj;
