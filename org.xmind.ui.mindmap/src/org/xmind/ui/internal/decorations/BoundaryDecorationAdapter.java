...
public class BoundaryDecorationAdapter extends AbstractBoundaryDecoration
        implements ICorneredDecoration {

    private IDecoration decoration;

    public BoundaryDecorationAdapter(IDecoration decoration) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == this)
            return true;
        if (obj instanceof BoundaryDecorationAdapter) {
            obj = ((BoundaryDecorationAdapter) obj).decoration;
        }
