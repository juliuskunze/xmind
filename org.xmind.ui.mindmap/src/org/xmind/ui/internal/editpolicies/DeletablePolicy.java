...
//    protected Command getDeleteCommand(List<IPart> sources, IViewer viewer) {
//        ITopic rootTopic = (ITopic) viewer.getAdapter(ITopic.class);
...
//                    others.add(m);
//                }
////            } else if (m instanceof IMarkerRef) {
////                IMarkerRef mr = (IMarkerRef) m;
////                ITopic parent = mr.getParent();
////                if (!topics.contains(parent)
////                        && !MindMapUtils.isAncestorInList(parent, topics)) {
////                    others.add(mr);
////                }
////            } else if (m instanceof IBoundary) {
////                IBoundary b = (IBoundary) m;
////                ITopic parent = b.getParent();
////                if (!topics.contains(parent)
////                        && !MindMapUtils.isAncestorInList(parent, topics)) {
////                    others.add(b);
////                }
////            } else if (m instanceof ISummary) {
////                ISummary s = (ISummary) m;
////                ITopic parent = s.getParent();
////                if (!topics.contains(parent)
////                        && !MindMapUtils.isAncestorInList(parent, topics)) {
////                    others.add(s);
////                }
////            } else if (m instanceof IImage) {
////                IImage i = (IImage) m;
////                ITopic parent = i.getParent();
////                if (!topics.contains(parent)
////                        && !MindMapUtils.isAncestorInList(parent, topics)) {
////                    others.add(i);
////                }
//            }
//        }
//        if (others.isEmpty() && topics.isEmpty())
//            return null;
//
...
//        if (command != null) {
//            List<Object> all = new ArrayList<Object>(sources.size());
//            all.addAll(topics);
//            all.addAll(others);
//            ICategoryAnalyzation result = MindMapUI.getCategoryManager()
//                    .analyze(all.toArray());
//            String label = getDeleteLabel(result.getMainCategory());
