...
public class HtmlConstants {
    ...
    public static final String[] TAGS_H = { "h1", "h2", "h3" }; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    public static final String TAG_UL = "ul"; //$NON-NLS-1$
    public static final String TAG_LI = "li"; //$NON-NLS-1$
    public static final String ATT_CLASS = "class"; //$NON-NLS-1$
    public static final String ATT_HREF = "href"; //$NON-NLS-1$
    public static final String ATT_SRC = "src"; //$NON-NLS-1$
    public static final String ATT_NAME = "name"; //$NON-NLS-1$
    public static final String ATT_ALIGN = "align"; //$NON-NLS-1$
    public static final String ATT_STYLE = "style"; //$NON-NLS-1$
    public static final String ATT_WIDTH = "width"; //$NON-NLS-1$
    public static final String ATT_HEIGHT = "height"; //$NON-NLS-1$
    ...
    public static final String LINE_SEP = "\r";//System.getProperty("line.separator"); //$NON-NLS-1$
