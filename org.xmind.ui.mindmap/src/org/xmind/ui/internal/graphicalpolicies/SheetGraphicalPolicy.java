...
public class SheetGraphicalPolicy extends AbstractGraphicalPolicy {

    private static final SheetGraphicalPolicy instance = new SheetGraphicalPolicy();
    ...
    protected IStyleSelector createDefaultStyleSelector() {
        return new SheetStyleSelector();
    }

    public static SheetGraphicalPolicy getInstance() {
        return instance;
    }
