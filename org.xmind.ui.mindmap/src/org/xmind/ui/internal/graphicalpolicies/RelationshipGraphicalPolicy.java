...
public class RelationshipGraphicalPolicy extends AbstractGraphicalPolicy {

    private static final RelationshipGraphicalPolicy instance = new RelationshipGraphicalPolicy();
    ...
    protected IStyleSelector createDefaultStyleSelector() {
        return new RelationshipStyleSelector();
    }

    public static RelationshipGraphicalPolicy getInstance() {
        return instance;
    }
