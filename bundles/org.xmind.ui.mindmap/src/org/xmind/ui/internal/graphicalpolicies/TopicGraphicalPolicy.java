...
public class TopicGraphicalPolicy extends AbstractGraphicalPolicy {

    private static final TopicGraphicalPolicy instance = new TopicGraphicalPolicy();
    ...
    protected IStyleSelector createDefaultStyleSelector() {
        return new TopicStyleSelector();
    }

    public static TopicGraphicalPolicy getInstance() {
        return instance;
    }
}