...
public class BoundaryGraphicalPolicy extends AbstractGraphicalPolicy {

    private static final BoundaryGraphicalPolicy instance = new BoundaryGraphicalPolicy();
    ...
    protected IStyleSelector createDefaultStyleSelector() {
        return new BoundaryStyleSelector();
    }

    public static BoundaryGraphicalPolicy getInstance() {
        return instance;
    }
}