...
public class SummaryDecorationAdapter extends AbstractSummaryDecoration
        implements ICorneredDecoration {

    private IDecoration decoration;

    public SummaryDecorationAdapter(IDecoration decoration) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == this)
            return true;
        if (obj instanceof SummaryDecorationAdapter) {
            obj = ((SummaryDecorationAdapter) obj).decoration;
        }
