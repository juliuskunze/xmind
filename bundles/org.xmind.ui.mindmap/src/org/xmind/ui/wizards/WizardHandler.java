 ...
 * @since 3.2
 */
public abstract class WizardHandler extends AbstractHandler implements
        IElementUpdater {
    ...
    public static final class New extends WizardHandler {
         ...
         * <code>null</code> to show all categories.
         * 
         * @return String
         */
        ...
        /**
         * Sets the id of the category of wizards to show or <code>null</code>
        ...
        protected IStructuredSelection getSelectionToUse(ExecutionEvent event) {
            ...
            if (selection instanceof IStructuredSelection) {
                ...
                if (resourceClass != null) {
                    IWorkbenchWindow activeWorkbenchWindow = HandlerUtil
                            .getActiveWorkbenchWindow(event);
                    IWorkbenchPart part = activeWorkbenchWindow
