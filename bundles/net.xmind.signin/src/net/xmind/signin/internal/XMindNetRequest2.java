...
//
//    public XMindNetRequest2() {
//        this(false);
//    }
//
//    public XMindNetRequest2(boolean useHTTPS) {
...
//    }
//
//    public XMindNetRequest2 uri(String api, Object... values) {
//        this.uri = EncodingUtils.format(api, values);
//        return this;
//    }
//
//    public XMindNetRequest2 domain(String domain) {
//        this.domain = domain;
//        return this;
//    }
//
//    public XMindNetRequest2 useHTTPS() {
//        this.useHTTPS = true;
//        return this;
//    }
//
//    public XMindNetRequest2 multipart() {
//        this.multipart = true;
//        return this;
//    }
//
//    public XMindNetRequest2 setAuthToken(String authToken) {
//        return this.addHeader("AuthToken", authToken); //$NON-NLS-1$
//    }
//
//    public XMindNetRequest2 addHeader(String name, String value) {
//        headers.add(new NameValuePair(name, value));
//        return this;
//    }
//
//    public XMindNetRequest2 addParameter(String name, Object value) {
...
//    }
//
//    public XMindNetRequest2 get() {
//        this.method = new GetMethod();
//        return execute();
//    }
//
//    public XMindNetRequest2 put() {
//        this.method = new PutMethod();
//        return execute();
//    }
//
//    public XMindNetRequest2 delete() {
//        this.method = new DeleteMethod();
//        return execute();
//    }
//
//    public XMindNetRequest2 post() {
//        this.method = new PostMethod();
//        return execute();
//    }
//
//    protected XMindNetRequest2 execute() {
//        if (isAborted())
//            return this;
//        prepare();
//        try {
...
//        }
//        method.setRequestHeader("X-Client-ID", "xmind_v3.4.1"); //$NON-NLS-1$ //$NON-NLS-2$
//    }
//
